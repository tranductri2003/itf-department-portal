...
public class UserBO {
	...
	public boolean updateUser(String id, String fullName, String phoneNumber, String email, String address, String avatar, String about) throws ClassNotFoundException, SQLException {
		return this.userDAO.updateUser(id, fullName, phoneNumber, email, "GV", address, avatar, about);
	}
