          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-10 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Tạo bài đăng mới</p>

                <form class="mx-1 mx-md-4" action="PostManagementServlet?action=insert" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <select id="category" name="category" class="form-control" required>
	                    <%
	                   	...
	                   	%>
	                   		<option value=<%= categoryList.get(i).getId()%>><%= categoryList.get(i).getTitle()%></option>
	                   	<%
	                    	}
	                    %>
                	  </select>
                  ...
                  <div class="d-flex flex-row mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <!-- Display the image using the default URL or user-selected file -->
						<img id="previewImage" src="" alt="Preview" class="img-fluid" style="max-width: 100%; max-height: 200px;" />
                  ...
                  <div class="d-flex flex-row mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <textarea id="excerpt" name="excerpt" rows="5" class="form-control" required /></textarea>
                  ...
                  <div class="d-flex flex-row mb-4">
                    <i class="fas fa-file-alt fa-lg me-2 fa-fw" style="padding:10px 30px 2.5px 2.5px"></i>
                    <div class="form-outline flex-fill mb-0">
                      <textarea id="content" name="content" rows="15" class="form-control" required /></textarea>
                  ...
                  <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                    ...
                    <input type="submit" value="Tạo bài đăng" class="btn btn-primary btn-lg" style="background-color: gray; border: 1px solid gray;">
                  </div>
